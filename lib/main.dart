...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          title: "Закрпеляй проблемы на карте свеого города",
          image: _buildImage('welone.png'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Общайся с жителями своего района",
        ...
        PageViewModel(
          title: "Получай баллы за достижения",
          bodyWidget: Row(
      ...
      done: const Text('Всё', style: TextStyle(fontWeight: FontWeight.w600)),

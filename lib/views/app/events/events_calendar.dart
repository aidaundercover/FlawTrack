              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('Бүгінге жоспарланған:',
                        style: TextStyle(
                            color: darkBlue,
                  ...
                  GestureDetector(
                      ...
                      child: eventTile(
                          context,
                          'Субботник на Айтаматова',
                          'assets/events/broom.png',
                          'у памятника Абая в 17:00',
                          Color.fromRGBO(255, 162, 141, 1.0),
                          _width)),
                  eventTile(
                      context,
                      'Велосипедный марафон',
                      'assets/events/bike.png',
                      'Парк Гагарина,у ворот в 9:00',
                      Color.fromRGBO(113, 204, 255, 1.0),
                      _width),
                  eventTile(
                      context,
                      'Вебинар по переработке мусора',
                      'assets/events/woman.png',
                      'в Zoom в 21:00',
                      Color.fromRGBO(185, 141, 255, 1.0),
                      _width)
                ],
              )),
        ]),

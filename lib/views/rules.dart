            ...
            children: [
              ...
              Table(
                border: TableBorder.all(  
                  ...
                  children: [  
                      TableRow( children: [  
                        Container(height: 50, child: Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/trashcan.png'), size: 24, color: black),
                        )])),  
                        Container(height: 50, child: Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Орынды емес қоқыс', style: TextStyle(fontSize: 15.0)),
                        )])),  
                      ]),  
                      TableRow( children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/road.png'), size: 24, color: black),
                        )]),  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Жол/тратуар сынған', style: TextStyle(fontSize: 15.0),),
                        )]),  
                      ]),
                      TableRow(  children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/dog.png'), size: 24, color: black),
                        )]),  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Үйсіз/жоғалған ит', style: TextStyle(fontSize: 15.0)),
                        )]),  
                      ]),
                      TableRow( children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/cat.png'), size: 24, color: black),
                        )]),  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Үйсіз/жоғалған мысық', style: TextStyle(fontSize: 15.0)),
                        )]),  
                      ]),  
                      TableRow( children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/trash.png'), size: 24, color: black),
                        )]),  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Орынды емес свалка', style: TextStyle(fontSize: 15.0)),
                        )]),  
                      ]),
                      TableRow( children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/drown.png'), size: 24, color: black),
                        )]),  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Су басылуы', style: TextStyle(fontSize: 15.0)),
                        )]),  
                      ]),
                      TableRow( children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/homeless.png'), size: 24, color: black),
                        )]),  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                      ...
                      TableRow( children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/volunteer.png'), size: 24, color: black),
                        )]),  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text('Волонтер', style: TextStyle(fontSize: 15.0)),
                        )]),  
                      ]),
                      TableRow( children: [  
                        Column(children:[Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ImageIcon(AssetImage('assets/pins/fixed.png'), size: 24, color: black),
                        )]),  
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Column(children:[Text('Түзетілді', style: TextStyle(fontSize: 15.0))]),
                        ),  
                      ]),
                    ],  
              ),

          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image:
                      DecorationImage(image: AssetImage('assets/events.png'))),
            ),
          ),
          Container(
            width: _width,
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                  dateFormatter(DateTime.now().subtract(Duration(days: 3)))
                      .toString(),
                  style: styleDay),
              SizedBox(
                height: 11,
              ...
              Text(
                getTheDay(DateTime.now().subtract(Duration(days: 3))),
                style: styleDate,
              )
            ],
          ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                  dateFormatter(DateTime.now().subtract(Duration(days: 4)))
                      .toString(),
                  style: styleDay),
              SizedBox(
                height: 11,
              ...
              Text(
                getTheDay(DateTime.now().subtract(Duration(days: 4))),
                style: styleDate,
              )
            ],
          ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                  dateFormatter(DateTime.now().subtract(Duration(days: 5)))
                      .toString(),
                  style: styleDay),
              SizedBox(
                height: 11,
              ...
              Text(
                getTheDay(DateTime.now().subtract(Duration(days: 5))),
                style: styleDate,
              )
            ],
          ),
